package com.qs.xutils3demo.model.entity;

import com.qs.xutils3demo.model.runnable.base.JsonResponseParser;
 ...
 */
@HttpResponse(parser = JsonResponseParser.class)//如果直接转化成对象   必须要声明
public class Qq {
