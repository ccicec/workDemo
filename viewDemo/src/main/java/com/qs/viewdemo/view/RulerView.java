...
public class RulerView extends View {
    ...
    private void drawIndicate(Canvas canvas, int position){
        ...
        if(position%5 !=0){
            ...
            top = (int) (bottom - indicateHeight * mIndicateScale)+20;
        ...
        canvas.drawLine(left, top, left, bottom, mIndicatePaint);
        lin = left;
        canvas.drawRect(left - lin, bottom, right, bottom+2, mIndicatePaint);
    }
    ...
    private void drawText(Canvas canvas, int position, String text){
      ...
      //  mTextPaint.setTextAlign(Paint.Align.CENTER);
        ...
        if(text.equals("0")){
            ...
            canvas.drawText(text+"000", x, y, mTextPaint);
        }
